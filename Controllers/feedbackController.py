    ...
    async def get_feedback_data_excel(self, file):
        try:
            ...
            return {
                ...
                "continue_doing_thing": analysis_general_continue_doing.get('structured', {}).get('continue_doing', []),
                "stop_doing_thing": analysis_general_stop_doing.get('structured', {}).get('stop_doing', []),
